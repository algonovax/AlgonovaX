...
def test_live_requires_kill_switch_when_flag_on(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("REQUIRE_KILL_SWITCH_FOR_LIVE", "1")
    monkeypatch.setenv("KILL_SWITCH_PATH", "./data/KILL_SWITCH")

    # kill switch NOT present => reject
